...
class PortLocation extends Component {
            ...
            <SafeAreaView style={{ flex: 1, backgroundColor: AppColor.colors.backgroundLight }}>
                ...
                <LinearGradient start={{ x: 1, y: 0 }} end={{ x: 0, y: 0 }} colors={[AppColor.colors.backgroundLight, AppColor.colors.backgroundLight]}
                    ...
                    <Header customStyles={{
                        ...
                        this.props.navigation.goBack();
                    }} title={I18n.t('aidToNavigation')}
                    />
                    <WebView
                        geolocationEnabled={true}
                        style={{ backgroundColor: AppColor.colors.backgroundLight }}
                        onShouldStartLoadWithRequest={(event) => {
                            if (event.url != 'https://satamp.net/ayuda-a-la-navegacion-mobile/') {
                        ...
                        // cacheEnabled={true}
                        source={{ uri: 'https://satamp.net/ayuda-a-la-navegacion-mobile/' }}
                    />
                </LinearGradient>
            </SafeAreaView>
        );
...
export default connect(mapStateToProps, mapDispatchToProps)(PortLocation);